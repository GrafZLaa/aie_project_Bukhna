...
from src.rules._constants import CYR_TO_LAT_LOOKALIKE, SERIAL_CONFUSABLES, RU_MONTHS
...
from src.eval.compare import _as_bool, _normalize_eval_scalar, _compare_eval_value
...
def health():
    return jsonify({
        "status": "ok",
        "service": "passport-ocr-extractor",
